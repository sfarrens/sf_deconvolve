...
htmlhelp_basename = 'sf_deconvolvedoc'
...
latex_documents = [
    (master_doc, 'sf_deconvolve.tex', u'sf\\_deconvolve Documentation',
...
man_pages = [
    (master_doc, 'sf_deconvolve', u'sf_deconvolve Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sf_deconvolve', u'sf_deconvolve Documentation',
     author, 'sf_deconvolve', 'One line description of project.',
     'Miscellaneous'),
]
